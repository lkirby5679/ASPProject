...
<%strType = request("strType")
  if strType="excel" then
	...
	Response.AddHeader "content-disposition","attachment;filename=timecards.xls"
  elseif strType="cdtf" then
 	Response.Contenttype="text"
	Response.AddHeader "content-disposition","attachment;filename=timecards.txt" 
  end if %>
