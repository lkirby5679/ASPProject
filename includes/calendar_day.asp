...
<table cellpadding="2" cellspacing="0" border="0" width="100%" align="center">
	<tr BGCOLOR="#BBBBBB">
		<td ALIGN="left"><a HREF="calendar.asp?date=<%=nDatePrev%>&view=day"><img src="<%=gsSiteRoot%>images/left.gif" border="0" WIDTH="25" HEIGHT="18"></a></td>
		<td ALIGN="center" colspan="5" CLASS="homeHeader"><%=curDateShow%></td>
		<td ALIGN="right"><a HREF="calendar.asp?date=<%=nDateNext%>&view=day"><img src="<%=gsSiteRoot%>images/right.gif" border="0" WIDTH="25" HEIGHT="18"></a></td>
	</tr>
</table>	
<table cellpadding="2" cellspacing="2" border="0" width="100%" align="center" bgcolor="<%=gsColorWhite%>">
<%
...
if not rs.eof then 
	...
	<tr>
		<td nowrap valign="top"><a href="javascript: popup2('<%=gsSiteRoot%>calendar/event.asp?id=<%=rs("id")%>');" class="bolddark"><%=rs("calendar_startTime")%></a></td>
